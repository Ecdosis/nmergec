...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libmvd_list.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.c} -dynamiclib -install_name libmvd_list.${CND_DLIB_EXT} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libmvd_list.${CND_DLIB_EXT} -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/mvd_list.o: mvd_list.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../NMergeC/include/mvd -I../../NMergeC/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/mvd_list.o mvd_list.c
