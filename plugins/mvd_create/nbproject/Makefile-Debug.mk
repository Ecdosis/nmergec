...
${OBJECTDIR}/_ext/688439529/plugin_log.o: ../shared/src/plugin_log.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I../../mvd/include -I../shared/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/688439529/plugin_log.o ../shared/src/plugin_log.c

${OBJECTDIR}/mvd_create.o: mvd_create.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../mvd/include -I../shared/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/mvd_create.o mvd_create.c
