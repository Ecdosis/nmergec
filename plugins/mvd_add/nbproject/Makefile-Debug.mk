...
${OBJECTDIR}/src/node.o: src/node.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/node.o src/node.c

${OBJECTDIR}/src/benchmark.o: src/benchmark.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/benchmark.o src/benchmark.c

${OBJECTDIR}/_ext/688439529/plugin_log.o: ../shared/src/plugin_log.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/688439529
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/688439529/plugin_log.o ../shared/src/plugin_log.c

${OBJECTDIR}/src/suffixtree.o: src/suffixtree.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/suffixtree.o src/suffixtree.c

${OBJECTDIR}/src/path.o: src/path.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/path.o src/path.c

${OBJECTDIR}/src/test.o: src/test.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/test.o src/test.c

${OBJECTDIR}/src/mvd_add.o: src/mvd_add.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -I../shared/include -I../../include -I../../mvd/include -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/mvd_add.o src/mvd_add.c
