...
${OBJECTDIR}/src/zip/zip.o: src/zip/zip.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/zip/zip.o src/zip/zip.c
...
${OBJECTDIR}/src/mvd/group.o: src/mvd/group.c 
	${MKDIR} -p ${OBJECTDIR}/src/mvd
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/mvd/group.o src/mvd/group.c
...
${OBJECTDIR}/src/benchmark.o: src/benchmark.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/benchmark.o src/benchmark.c
...
${OBJECTDIR}/src/mvd/serialiser.o: src/mvd/serialiser.c 
	${MKDIR} -p ${OBJECTDIR}/src/mvd
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/mvd/serialiser.o src/mvd/serialiser.c
...
${OBJECTDIR}/src/link_node.o: src/link_node.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/link_node.o src/link_node.c
...
${OBJECTDIR}/src/hsieh.o: src/hsieh.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hsieh.o src/hsieh.c
