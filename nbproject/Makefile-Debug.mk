...
${OBJECTDIR}/kmpsearch.o: kmpsearch.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/kmpsearch.o kmpsearch.c

${OBJECTDIR}/output_stream.o: output_stream.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/output_stream.o output_stream.c

${OBJECTDIR}/mvdtool.o: mvdtool.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/mvdtool.o mvdtool.c

${OBJECTDIR}/empty_output_stream.o: empty_output_stream.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/empty_output_stream.o empty_output_stream.c
